...
8. Add the prefix "prism-" in front of all .token.* CSS rules, e.g. replace .token.comment with .prism-token.prism-comment
   Do NOT add the prefix in front of .language-css for example.
